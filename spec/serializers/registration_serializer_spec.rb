  ...
  describe RegistrationSerializer do
    describe "#serialize" do
      ...
      context "when questionnaire enabled" do
        ...
        context "when there is a guest" do
          let!(:guest_registration) { create(:guest_meeting_registration, create_registration: false, user: user, organization: registration.meeting.organization, meeting: registration.meeting) }
